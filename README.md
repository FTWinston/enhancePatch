...
Megapatch patch objects will not natively serialize to and deserialize from JSON, as they contain `Map` and `Set` objects. For this reason, it is recommended to use [superjson](https://github.com/blitz-js/superjson) to stringify and parse patches.
